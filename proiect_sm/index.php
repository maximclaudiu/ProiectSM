...
exec('python /var/www/html/proiect_sm/cpin7l.py');
}
if (isset($_POST['roff']))  //  Red Off
{
exec('python /var/www/html/proiect_sm/cpin7h.py');
}
if (isset($_POST['gon']))  // Green On
{
exec('python /var/www/html/proiect_sm/cpin5l.py');
}
if (isset($_POST['goff']))  // Green Off
{
exec('python /var/www/html/proiect_sm/cpin5h.py');
}
if (isset($_POST['bon']))  // Blue On
{
exec('python /var/www/html/proiect_sm/cpin3l.py');
}
if (isset($_POST['boff']))  // Blue Off
{
exec('python /var/www/html/proiect_sm/cpin3h.py');
